...
─────
    ...
    python src/run_clustering.py --set "CLUSTERING_THRESHOLD_JY=3.0"
...
_MODULE_DIR = _SCRIPT_DIR / 'modules'
if str(_SCRIPT_DIR) not in sys.path:
    sys.path.insert(0, str(_SCRIPT_DIR))

from modules import ugmrt_query as q  # noqa: E402
from modules.workflow_common import (  # noqa: E402
...
def _load_outlier_detection():
    """Import outlier_detection.py from src/modules."""
    od_path = _MODULE_DIR / 'outlier_detection.py'
...
def main() -> None:
    _default_cfg = str(_SCRIPT_DIR.parent / 'preprocess_ugmrt.cfg')
